...
///
/// Defines hardware icons
///
void defineHardwareIcons() {
  if (AlgIronIconset.isDefined('hardware')) return;

  final HtmlElement definition = document.createElement('div')
    ..setInnerHtml('''<svg><defs>
